		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-4 col-md-offset-8">
					...
					<div class="col-md-7">
						<input class="form-control" placeholder="Search by name" type="text" name="search" class="search" id="key">
					</div>
...
@section('scripts')
	<script>
        var draw = function(data){
            ...
            var img = $("<img></img>").addClass("img-responsive").attr("src", "http:\/\/placehold.it/350x260");
